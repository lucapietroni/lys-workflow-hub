...
def from_pratica(
    ...
    return VerbaleData(
        ...
        rca=_get("rca", auto.franchigia_rca if auto else ""),
        kasco=_get("kasco", auto.franchigia_kasco if auto else ""),
        furto_incendio=_get("furto_incendio", auto.franchigia_furto_incendio if auto else ""),

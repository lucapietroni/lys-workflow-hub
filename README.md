...
> Branch attivo: **v2** · Versione: **3.11.0**
...
| `v2` | **3.11.0** | Sviluppo attivo — verbali cortesia + foto lavorazioni automatiche + foto/documenti in pratica (vista + upload dal portale esterno) + autenticazione/pubblicazione internet + assegnazione pratiche + note/calendario condivisi + notifiche collaborazione (real-time + self-service + reminder schedulati) + stato pratica nel portale (vista + modifica) + CSRF su tutti i form + calendario mensile + UI responsive tablet/telefono |
